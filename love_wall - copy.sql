...
CREATE TABLE `admin_apps`  (
  ...
  `app_id` int(11) NOT NULL COMMENT '微信小程序id',
  `created_at` timestamp(0) NULL DEFAULT NULL,
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  `deleted_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `admins`  (
  ...
  `avatar` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '用户头像',
...
CREATE TABLE `apps`  (
  ...
  `college_id` int(11) NULL DEFAULT NULL COMMENT '学校',
  `status` tinyint(4) NOT NULL DEFAULT 2 COMMENT '小程序的状态，1=正常，2=非法',
  `created_at` timestamp(0) NULL DEFAULT NULL,
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  `deleted_at` timestamp(0) NULL DEFAULT NULL,
  `service_id` int(11) NULL DEFAULT NULL COMMENT '客服id',
  `attachments` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '小程序的相关图片',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `chat_messages`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `from_user_id` int(11) NOT NULL COMMENT '发送消息者',
  `to_user_id` int(11) NOT NULL COMMENT '接受信息者',
  `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '内容',
  `attachments` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '附件',
...
) ENGINE = InnoDB AUTO_INCREMENT = 7967 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `comments`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `commenter_id` int(11) NOT NULL COMMENT '评论人',
  `obj_id` int(11) NOT NULL COMMENT '改评论所属的贴子',
  `college_id` int(11) NULL DEFAULT NULL COMMENT '学校',
  `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '评论的内容',
  `attachments` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '评论的附件,例图片',
  `ref_comment_id` int(11) NULL DEFAULT NULL COMMENT '改评论所评论的评论Id',
...
) ENGINE = InnoDB AUTO_INCREMENT = 6331 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `compare_faces`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '用户ID',
  `attachments` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '对比的照片',
  `confidence` double(8, 2) NOT NULL DEFAULT 0.00 COMMENT '比对的相识度',
  `status` tinyint(4) NOT NULL DEFAULT 1 COMMENT '比对成功',
  `compare_result` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '比对结果',
  `created_at` timestamp(0) NULL DEFAULT NULL,
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  `deleted_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 14630 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `employee_part_time_jobs`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `part_time_job_id` int(11) NOT NULL COMMENT '悬赏ID',
  `user_id` int(11) NOT NULL COMMENT '赏金猎人ID',
...
CREATE TABLE `follows`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '关注人',
  `obj_id` int(11) NOT NULL COMMENT '关注的对象',
...
) ENGINE = InnoDB AUTO_INCREMENT = 5912 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 3655 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 23331 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `match_loves`  (
  ...
  `attachments` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '贴子的附件,例如图片',
...
) ENGINE = InnoDB AUTO_INCREMENT = 892 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `part_time_jobs`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '悬赏人ID',
  ...
  `attachments` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '悬赏附件',
...
CREATE TABLE `posts`  (
  ...
  `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '贴子的内容',
  `attachments` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '贴子的附件,例如图片',
...
) ENGINE = InnoDB AUTO_INCREMENT = 14816 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `praises`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `owner_id` int(11) NOT NULL COMMENT '点赞人',
  `obj_id` int(11) NOT NULL COMMENT '被点赞对象Id',
  `obj_type` tinyint(4) NOT NULL DEFAULT 0 COMMENT '被点赞对象的类型',
  `college_id` int(11) NULL DEFAULT NULL COMMENT '学校Id',
  `created_at` timestamp(0) NULL DEFAULT NULL,
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  `deleted_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `run_steps`  (
  ...
  `step` int(11) NOT NULL DEFAULT 0 COMMENT '用户的步数',
...
) ENGINE = InnoDB AUTO_INCREMENT = 129094 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `sale_friends`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `owner_id` int(11) NOT NULL COMMENT '所属人Id',
  `college_id` int(11) NULL DEFAULT NULL COMMENT '学校Id',
...
CREATE TABLE `secret_messages`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `post_user_id` int(11) NOT NULL COMMENT '发送人用户ID',
  `receive_user_id` int(11) NULL DEFAULT NULL COMMENT '接收人id',
  `message_session_id` int(11) NOT NULL COMMENT '短信会话ID',
  `number` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0000' COMMENT '编号',
  `code` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '内容',
  `attachments` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '附件的内容',
  `status` tinyint(4) NOT NULL DEFAULT 1 COMMENT '是否已读，1=未读，2=已读',
  `delay_at` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '延期发送的时间',
...
CREATE TABLE `secret_messages_visit_logs`  (
  ...
  `user_id` int(11) NOT NULL COMMENT '用户Id',
  `secret_message_id` int(11) NOT NULL COMMENT '秘言ID',
  `created_at` timestamp(0) NULL DEFAULT NULL,
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  `deleted_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `send_messages`  (
  ...
  `message_session_id` int(11) NULL DEFAULT NULL COMMENT '消息的ID',
...
CREATE TABLE `template_key_words`  (
  ...
  `keyword_ids` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '消息模板关键字组合模板排列ID',
  `created_at` timestamp(0) NULL DEFAULT NULL,
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  `deleted_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `template_logs`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `app_id` int(11) NOT NULL COMMENT '所属小程序',
  ...
  `content` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '发送的内容',
  `result` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '返回结果',
...
CREATE TABLE `topics`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '话题发布者，可以是后台管理员和用户',
  ...
  `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '内容',
  `attachments` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '附件',
  `praise_number` int(11) NOT NULL DEFAULT 0 COMMENT '点赞人数',
  `view_number` int(11) NOT NULL DEFAULT 0 COMMENT '浏览人数',
  `comment_number` int(11) NOT NULL DEFAULT 1 COMMENT '评论人数',
...
CREATE TABLE `travel_log_pois`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `travel_log_id` int(11) NOT NULL COMMENT '所属旅行日志',
...
) ENGINE = InnoDB AUTO_INCREMENT = 15082 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `travel_logs`  (
  ...
  `point_id` int(11) NULL DEFAULT NULL COMMENT '所属站点',
...
) ENGINE = InnoDB AUTO_INCREMENT = 7331 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `travel_plan_points`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `travel_plan_id` int(11) NOT NULL COMMENT '旅行计划',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1312 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `travel_plans`  (
  ...
  `distance` int(11) NOT NULL COMMENT '旅行的总路程，单位是米',
...
CREATE TABLE `users`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `app_id` int(11) NOT NULL COMMENT '小程序id',
  `nickname` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '用户微信昵称',
  `password` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '预留账号密码',
  `mobile` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '预留手机号码字段',
...
) ENGINE = InnoDB AUTO_INCREMENT = 37474 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `videos`  (
  ...
  `app_id` int(11) NOT NULL,
  `attachments` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '视频链接地址',
